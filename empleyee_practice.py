...
kj,mbkasdcasdc
#         self.price = pricesadcsacd as
#         print(f"Mobasdile creatqasdcasdwefesdd with brand nm{self.brand} and price {self.price}")
...
#         print(sadf"modile brand {self.brand} with the prdsadcice {self.price} ")
qwe
